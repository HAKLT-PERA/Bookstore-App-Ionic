...
export class SharedDataService {
  ...
  public tab3: any = [1,{ id : 12, sale_price:10, regular_price:100,on_sale:true, name:"Akila", stock_status:'instock',type:'simple',images:['https://bfnsrilanka.org/images/ETHNOBOTANY_DATA/page3/jam_pera.jpg']} ];
